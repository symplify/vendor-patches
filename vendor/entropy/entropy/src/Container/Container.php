...
namespace VendorPatches202609\Entropy\Container;

use VendorPatches202609\Entropy\Attributes\RelatedTest;
use VendorPatches202609\Entropy\Console\CommandRegistry;
use VendorPatches202609\Entropy\Console\Contract\CommandInterface;
use VendorPatches202609\Entropy\Container\Exception\CreateServiceException;
use VendorPatches202609\Entropy\Container\Exception\RegisterServiceException;
use VendorPatches202609\Entropy\Reflection\ParameterTypesResolver;
use VendorPatches202609\Entropy\Tests\Container\Container\ContainerTest;
use ReflectionClass;
use ReflectionMethod;
use ReflectionParameter;
use VendorPatches202609\Webmozart\Assert\Assert;
/**
...
class Container
{
    ...
    public function findByContract(string $contractClass) : array
    {
        ...
        $matches = \array_filter($this->instances, function (object $instance) use($contractClass) : bool {
