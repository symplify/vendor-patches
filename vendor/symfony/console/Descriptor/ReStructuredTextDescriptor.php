 ...
 */
namespace VendorPatches202511\Symfony\Component\Console\Descriptor;
...
class ReStructuredTextDescriptor extends Descriptor
{
    ...
    {
        $globalOptions = ['help', 'silent', 'quiet', 'verbose', 'version', 'ansi', 'no-interaction'];
        $nonDefaultOptions = [];
        foreach ($definition->getOptions() as $option) {
            // Skip global options.
            if (!\in_array($option->getName(), $globalOptions, \true)) {
