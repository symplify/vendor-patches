...
class ProgressIndicator
{
     ...
     * @var string
     */
    private $finishedIndicatorValue;
    /**
     * @var float
     */
    ...
    public function __construct(OutputInterface $output, ?string $format = null, int $indicatorChangeInterval = 100, ?array $indicatorValues = null, ?string $finishedIndicatorValue = null)
    {
        ...
        $finishedIndicatorValue = $finishedIndicatorValue ?? '✔';
    ...
    private static function initPlaceholderFormatters() : array
    {
        return ['indicator' => function (self $indicator) {
            return $indicator->finished ? $indicator->finishedIndicatorValue : $indicator->indicatorValues[$indicator->indicatorCurrent % \count($indicator->indicatorValues)];
