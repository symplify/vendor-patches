...
use VendorPatches202511\Symfony\Component\Process\Exception\ProcessFailedException;
...
class ProcessHelper extends Helper
{
     ...
     * @see run()
     */
    public function mustRun(OutputInterface $output, $cmd, ?string $error = null, ?callable $callback = null, int $verbosity = OutputInterface::VERBOSITY_VERY_VERBOSE) : Process
    {
