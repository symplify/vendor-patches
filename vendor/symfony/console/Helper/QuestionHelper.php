...
use VendorPatches202511\Symfony\Component\Console\Cursor;
use VendorPatches202511\Symfony\Component\Console\Exception\MissingInputException;
...
use VendorPatches202511\Symfony\Component\Console\Formatter\OutputFormatterStyle;
use VendorPatches202511\Symfony\Component\Console\Input\InputInterface;
use VendorPatches202511\Symfony\Component\Console\Input\StreamableInputInterface;
...
use function VendorPatches202511\Symfony\Component\String\s;
/**
...
class QuestionHelper extends Helper
{
    ...
    public function ask(InputInterface $input, OutputInterface $output, Question $question)
    {
        ...
        try {
            ...
            $interviewer = function () use($inputStream, $output, $question) {
                return $this->doAsk($inputStream, $output, $question);
            };
     ...
     * @return mixed
     */
    private function doAsk($inputStream, OutputInterface $output, Question $question)
    {
            ...
            if (\false === $c || '' === $ret && '' === $c && null === $question->getDefault()) {
                ...
                if ("\t" === $c || "\n" === $c) {
                    if ($numMatches > 0 && -1 !== $ofs) {
                        ...
                        $remainingCharacters = (string) \substr($ret, \strlen(\trim($this->mostRecentlyEnteredValue($fullChoice))));
