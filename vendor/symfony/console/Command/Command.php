...
use VendorPatches202212\Symfony\Component\Console\Attribute\AsCommand;
...
use VendorPatches202212\Symfony\Component\Console\Helper\HelperInterface;
...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('VendorPatches202212\\setproctitle')) {
