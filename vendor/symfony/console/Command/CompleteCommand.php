...
use VendorPatches202511\Symfony\Component\Console\Completion\Output\BashCompletionOutput;
use VendorPatches202511\Symfony\Component\Console\Completion\Output\CompletionOutputInterface;
use VendorPatches202511\Symfony\Component\Console\Completion\Output\FishCompletionOutput;
use VendorPatches202511\Symfony\Component\Console\Completion\Output\ZshCompletionOutput;
...
final class CompleteCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        try {
            ...
            $this->log(['', '<comment>' . \date('Y-m-d H:i:s') . '</>', '<info>Input:</> <comment>("|" indicates the cursor position)</>', '  ' . $completionInput, '<info>Command:</>', '  ' . \implode(' ', $_SERVER['argv']), '<info>Messages:</>']);
