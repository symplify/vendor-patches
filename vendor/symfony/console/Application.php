 ...
 */
namespace VendorPatches202511\Symfony\Component\Console;

use VendorPatches202511\Symfony\Component\Console\Command\Command;
use VendorPatches202511\Symfony\Component\Console\Command\CompleteCommand;
use VendorPatches202511\Symfony\Component\Console\Command\DumpCompletionCommand;
use VendorPatches202511\Symfony\Component\Console\Command\HelpCommand;
use VendorPatches202511\Symfony\Component\Console\Command\LazyCommand;
use VendorPatches202511\Symfony\Component\Console\Command\ListCommand;
use VendorPatches202511\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
...
use VendorPatches202511\Symfony\Component\Console\Event\ConsoleAlarmEvent;
use VendorPatches202511\Symfony\Component\Console\Event\ConsoleCommandEvent;
use VendorPatches202511\Symfony\Component\Console\Event\ConsoleErrorEvent;
use VendorPatches202511\Symfony\Component\Console\Event\ConsoleSignalEvent;
use VendorPatches202511\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use VendorPatches202511\Symfony\Component\Console\Exception\CommandNotFoundException;
use VendorPatches202511\Symfony\Component\Console\Exception\ExceptionInterface;
use VendorPatches202511\Symfony\Component\Console\Exception\LogicException;
use VendorPatches202511\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use VendorPatches202511\Symfony\Component\Console\Exception\RuntimeException;
use VendorPatches202511\Symfony\Component\Console\Formatter\OutputFormatter;
use VendorPatches202511\Symfony\Component\Console\Helper\DebugFormatterHelper;
use VendorPatches202511\Symfony\Component\Console\Helper\DescriptorHelper;
use VendorPatches202511\Symfony\Component\Console\Helper\FormatterHelper;
use VendorPatches202511\Symfony\Component\Console\Helper\Helper;
use VendorPatches202511\Symfony\Component\Console\Helper\HelperSet;
use VendorPatches202511\Symfony\Component\Console\Helper\ProcessHelper;
use VendorPatches202511\Symfony\Component\Console\Helper\QuestionHelper;
use VendorPatches202511\Symfony\Component\Console\Input\ArgvInput;
use VendorPatches202511\Symfony\Component\Console\Input\ArrayInput;
...
use VendorPatches202511\Symfony\Component\Console\Output\ConsoleOutput;
...
use VendorPatches202511\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use VendorPatches202511\Symfony\Component\Console\Style\SymfonyStyle;
use VendorPatches202511\Symfony\Component\ErrorHandler\ErrorHandler;
use VendorPatches202511\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use VendorPatches202511\Symfony\Contracts\Service\ResetInterface;
/**
...
class Application implements ResetInterface
{
    ...
    public function find(string $name) : Command
    {
        ...
        if (\count($commands) > 1) {
            ...
            $commands = \array_unique(\array_filter($commands, function ($nameOrAlias) use(&$commandList, $commands, &$aliases) {
                ...
                return $commandName === $nameOrAlias || !\in_array($commandName, $commands, \true);
            }));
        }
        if (\count($commands) > 1) {
    ...
    protected function configureIO(InputInterface $input, OutputInterface $output) : void
    {
        ...
        switch (\true) {
            case $input->hasParameterOption(['--silent'], \true):
                $shellVerbosity = -2;
                break;
            case $input->hasParameterOption(['--quiet', '-q'], \true):
                $shellVerbosity = -1;
                break;
            case $input->hasParameterOption('-vvv', \true) || $input->hasParameterOption('--verbose=3', \true) || 3 === $input->getParameterOption('--verbose', \false, \true):
                $shellVerbosity = 3;
                break;
            case $input->hasParameterOption('-vv', \true) || $input->hasParameterOption('--verbose=2', \true) || 2 === $input->getParameterOption('--verbose', \false, \true):
                $shellVerbosity = 2;
                break;
            case $input->hasParameterOption('-v', \true) || $input->hasParameterOption('--verbose=1', \true) || $input->hasParameterOption('--verbose', \true) || $input->getParameterOption('--verbose', \false, \true):
                $shellVerbosity = 1;
                break;
            default:
                $shellVerbosity = (int) ($_ENV['SHELL_VERBOSITY'] ?? $_SERVER['SHELL_VERBOSITY'] ?? \getenv('SHELL_VERBOSITY'));
                break;
        }
        $output->setVerbosity((function () use($shellVerbosity, $output) {
            switch ($shellVerbosity) {
                case -2:
                    return OutputInterface::VERBOSITY_SILENT;
                case -1:
                ...
                default:
                    return ($shellVerbosity = 0) ?: $output->getVerbosity();
            }
        })());
    ...
    {
        return new InputDefinition([new InputArgument('command', InputArgument::REQUIRED, 'The command to execute'), new InputOption('--help', '-h', InputOption::VALUE_NONE, 'Display help for the given command. When no command is given display help for the <info>' . $this->defaultCommand . '</info> command'), new InputOption('--silent', null, InputOption::VALUE_NONE, 'Do not output any message'), new InputOption('--quiet', '-q', InputOption::VALUE_NONE, 'Only errors are displayed. All other output is suppressed'), new InputOption('--verbose', '-v|vv|vvv', InputOption::VALUE_NONE, 'Increase the verbosity of messages: 1 for normal output, 2 for more verbose output and 3 for debug'), new InputOption('--version', '-V', InputOption::VALUE_NONE, 'Display this application version'), new InputOption('--ansi', '', InputOption::VALUE_NEGATABLE, 'Force (or disable --no-ansi) ANSI output', null), new InputOption('--no-interaction', '-n', InputOption::VALUE_NONE, 'Do not ask any interactive question')]);
    }
    /**
