...
use VendorPatches202207\Symfony\Component\Console\Command\CompleteCommand;
use VendorPatches202207\Symfony\Component\Console\Command\DumpCompletionCommand;
use VendorPatches202207\Symfony\Component\Console\Command\HelpCommand;
use VendorPatches202207\Symfony\Component\Console\Command\LazyCommand;
use VendorPatches202207\Symfony\Component\Console\Command\ListCommand;
use VendorPatches202207\Symfony\Component\Console\Command\SignalableCommandInterface;
use VendorPatches202207\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use VendorPatches202207\Symfony\Component\Console\Completion\CompletionInput;
use VendorPatches202207\Symfony\Component\Console\Completion\CompletionSuggestions;
use VendorPatches202207\Symfony\Component\Console\Event\ConsoleCommandEvent;
use VendorPatches202207\Symfony\Component\Console\Event\ConsoleErrorEvent;
use VendorPatches202207\Symfony\Component\Console\Event\ConsoleSignalEvent;
use VendorPatches202207\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use VendorPatches202207\Symfony\Component\Console\Exception\CommandNotFoundException;
use VendorPatches202207\Symfony\Component\Console\Exception\ExceptionInterface;
use VendorPatches202207\Symfony\Component\Console\Exception\LogicException;
use VendorPatches202207\Symfony\Component\Console\Exception\NamespaceNotFoundException;
...
use VendorPatches202207\Symfony\Component\Console\Helper\DebugFormatterHelper;
use VendorPatches202207\Symfony\Component\Console\Helper\FormatterHelper;
use VendorPatches202207\Symfony\Component\Console\Helper\Helper;
use VendorPatches202207\Symfony\Component\Console\Helper\HelperSet;
use VendorPatches202207\Symfony\Component\Console\Helper\ProcessHelper;
use VendorPatches202207\Symfony\Component\Console\Helper\QuestionHelper;
use VendorPatches202207\Symfony\Component\Console\Input\ArgvInput;
use VendorPatches202207\Symfony\Component\Console\Input\ArrayInput;
use VendorPatches202207\Symfony\Component\Console\Input\InputArgument;
use VendorPatches202207\Symfony\Component\Console\Input\InputAwareInterface;
use VendorPatches202207\Symfony\Component\Console\Input\InputDefinition;
use VendorPatches202207\Symfony\Component\Console\Input\InputInterface;
use VendorPatches202207\Symfony\Component\Console\Input\InputOption;
...
use VendorPatches202207\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use VendorPatches202207\Symfony\Component\Console\Style\SymfonyStyle;
use VendorPatches202207\Symfony\Component\ErrorHandler\ErrorHandler;
use VendorPatches202207\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use VendorPatches202207\Symfony\Contracts\Service\ResetInterface;
/**
