 ...
 */
namespace VendorPatches202511\Symfony\Component\Console\DataCollector;

use VendorPatches202511\Symfony\Component\Console\Command\Command;
use VendorPatches202511\Symfony\Component\Console\Debug\CliRequest;
use VendorPatches202511\Symfony\Component\Console\Output\OutputInterface;
use VendorPatches202511\Symfony\Component\Console\SignalRegistry\SignalMap;
use VendorPatches202511\Symfony\Component\HttpFoundation\Request;
use VendorPatches202511\Symfony\Component\HttpFoundation\Response;
use VendorPatches202511\Symfony\Component\HttpKernel\DataCollector\DataCollector;
use VendorPatches202511\Symfony\Component\VarDumper\Cloner\Data;
/**
 * @internal
 *
...
final class CommandDataCollector extends DataCollector
{
    public function collect(Request $request, Response $response, ?\Throwable $exception = null) : void
    {
        ...
        $this->data = ['command' => $command->invokableCommandInfo ?? $this->cloneVar($command->command), 'exit_code' => $command->exitCode, 'interrupted_by_signal' => $command->interruptedBySignal, 'duration' => $command->duration, 'max_memory_usage' => $command->maxMemoryUsage, 'verbosity_level' => (function () use($command) {
            switch ($command->output->getVerbosity()) {
                case OutputInterface::VERBOSITY_SILENT:
                    return 'silent';
