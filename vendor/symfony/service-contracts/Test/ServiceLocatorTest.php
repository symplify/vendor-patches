 ...
 */
namespace VendorPatches20220610\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\VendorPatches20220610\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\VendorPatches20220610\Psr\Container\ContainerExceptionInterface::class);
