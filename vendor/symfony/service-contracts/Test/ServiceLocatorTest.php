 ...
 */
namespace VendorPatches202211\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\VendorPatches202211\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\VendorPatches202211\Psr\Container\ContainerExceptionInterface::class);
