 ...
 */
namespace VendorPatches202302\Symfony\Component\Config\Builder;

use VendorPatches202302\Symfony\Component\Config\Definition\ArrayNode;
use VendorPatches202302\Symfony\Component\Config\Definition\BaseNode;
use VendorPatches202302\Symfony\Component\Config\Definition\BooleanNode;
use VendorPatches202302\Symfony\Component\Config\Definition\Builder\ExprBuilder;
use VendorPatches202302\Symfony\Component\Config\Definition\ConfigurationInterface;
use VendorPatches202302\Symfony\Component\Config\Definition\EnumNode;
use VendorPatches202302\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
use VendorPatches202302\Symfony\Component\Config\Definition\FloatNode;
use VendorPatches202302\Symfony\Component\Config\Definition\IntegerNode;
use VendorPatches202302\Symfony\Component\Config\Definition\NodeInterface;
use VendorPatches202302\Symfony\Component\Config\Definition\PrototypedArrayNode;
use VendorPatches202302\Symfony\Component\Config\Definition\ScalarNode;
use VendorPatches202302\Symfony\Component\Config\Definition\VariableNode;
use VendorPatches202302\Symfony\Component\Config\Loader\ParamConfigurator;
/**
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('VendorPatches202302\\Symfony\\Config', $rootNode->getName());
