 ...
 */
namespace VendorPatches20220610\Symfony\Component\String;

use VendorPatches20220610\Symfony\Component\String\Exception\ExceptionInterface;
use VendorPatches20220610\Symfony\Component\String\Exception\InvalidArgumentException;
use VendorPatches20220610\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    public function snake()
    {
        ...
        $str->string = \mb_strtolower(\preg_replace(['/(\\p{Lu}+)(\\p{Lu}\\p{Ll})/u', '/([\\p{Ll}0-9])(\\p{Lu})/u'], 'VendorPatches20220610\\1_\\2', $str->string), 'UTF-8');
        return $str;
    }
    /**
     * @return $this
