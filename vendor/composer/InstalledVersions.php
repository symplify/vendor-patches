 ...
 */
namespace VendorPatches202212\Composer;

use VendorPatches202212\Composer\Autoload\ClassLoader;
use VendorPatches202212\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches202212\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
