 ...
 */
namespace VendorPatches202206\Composer;

use VendorPatches202206\Composer\Autoload\ClassLoader;
use VendorPatches202206\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches202206\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
