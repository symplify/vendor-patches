 ...
 */
namespace VendorPatches20220612\Composer;

use VendorPatches20220612\Composer\Autoload\ClassLoader;
use VendorPatches20220612\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches20220612\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
