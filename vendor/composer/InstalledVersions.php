 ...
 */
namespace VendorPatches202301\Composer;

use VendorPatches202301\Composer\Autoload\ClassLoader;
use VendorPatches202301\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches202301\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
