 ...
 */
namespace VendorPatches202208\Composer;

use VendorPatches202208\Composer\Autoload\ClassLoader;
use VendorPatches202208\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches202208\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
