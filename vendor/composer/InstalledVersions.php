 ...
 */
namespace VendorPatches202211\Composer;

use VendorPatches202211\Composer\Autoload\ClassLoader;
use VendorPatches202211\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches202211\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
