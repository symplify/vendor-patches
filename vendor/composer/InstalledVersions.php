 ...
 */
namespace VendorPatches202209\Composer;

use VendorPatches202209\Composer\Autoload\ClassLoader;
use VendorPatches202209\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches202209\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
