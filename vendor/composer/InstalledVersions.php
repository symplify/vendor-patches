 ...
 */
namespace VendorPatches202207\Composer;

use VendorPatches202207\Composer\Autoload\ClassLoader;
use VendorPatches202207\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches202207\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
