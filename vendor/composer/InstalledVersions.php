 ...
 */
namespace VendorPatches202302\Composer;

use VendorPatches202302\Composer\Autoload\ClassLoader;
use VendorPatches202302\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches202302\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
