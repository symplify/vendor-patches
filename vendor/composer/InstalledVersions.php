 ...
 */
namespace VendorPatches202210\Composer;

use VendorPatches202210\Composer\Autoload\ClassLoader;
use VendorPatches202210\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('VendorPatches202210\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
