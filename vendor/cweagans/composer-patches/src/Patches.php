 ...
 */
namespace VendorPatches202502\cweagans\Composer;

use VendorPatches202502\Composer\Composer;
use VendorPatches202502\Composer\DependencyResolver\Operation\InstallOperation;
use VendorPatches202502\Composer\DependencyResolver\Operation\UninstallOperation;
use VendorPatches202502\Composer\DependencyResolver\Operation\UpdateOperation;
use VendorPatches202502\Composer\DependencyResolver\Operation\OperationInterface;
use VendorPatches202502\Composer\EventDispatcher\EventSubscriberInterface;
use VendorPatches202502\Composer\IO\IOInterface;
use VendorPatches202502\Composer\Package\AliasPackage;
use VendorPatches202502\Composer\Package\PackageInterface;
use VendorPatches202502\Composer\Plugin\PluginInterface;
use VendorPatches202502\Composer\Installer\PackageEvents;
use VendorPatches202502\Composer\Script\Event;
use VendorPatches202502\Composer\Script\ScriptEvents;
use VendorPatches202502\Composer\Installer\PackageEvent;
use VendorPatches202502\Composer\Util\ProcessExecutor;
use VendorPatches202502\Composer\Util\RemoteFilesystem;
use VendorPatches202502\Symfony\Component\Process\Process;
class Patches implements PluginInterface, EventSubscriberInterface
{
    ...
    protected function executeCommand($cmd)
    {
        ...
        $command = \call_user_func_array('VendorPatches202502\\sprintf', $args);
        $output = '';
        if ($this->io->isVerbose()) {
