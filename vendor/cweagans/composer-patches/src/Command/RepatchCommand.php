...
class RepatchCommand extends PatchesCommandBase
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $localRepository = $this->requireComposer()->getRepositoryManager()->getLocalRepository();
        ...
        foreach ($packages as $package) {
            ...
            $promises[] = $this->requireComposer()->getInstallationManager()->uninstall($localRepository, $uninstallOperation);
        }
