...
use LogicException;
use VendorPatches202602\Seld\JsonLint\ParsingException;
class Locker
{
    /**
     ...
     * @var bool
     */
    protected $virtualFileWritten = \false;
    /**
     * @var mixed[]|null
     */
    protected $lockDataCache;
    /**
     * @var string
     */
    protected $hash;
    ...
    public function setLockData(PatchCollection $patchCollection, bool $write = \true) : bool
    {
