 ...
 */
namespace VendorPatches202607\cweagans\Composer\Plugin;

use VendorPatches202607\Composer\Composer;
use VendorPatches202607\Composer\DependencyResolver\Operation\InstallOperation;
use VendorPatches202607\Composer\DependencyResolver\Operation\OperationInterface;
use VendorPatches202607\Composer\DependencyResolver\Operation\UpdateOperation;
use VendorPatches202607\Composer\EventDispatcher\EventDispatcher;
use VendorPatches202607\Composer\EventDispatcher\EventSubscriberInterface;
use VendorPatches202607\Composer\Installer\PackageEvent;
use VendorPatches202607\Composer\Installer\PackageEvents;
use VendorPatches202607\Composer\IO\IOInterface;
use VendorPatches202607\Composer\Json\JsonFile;
use VendorPatches202607\Composer\Package\PackageInterface;
use VendorPatches202607\Composer\Plugin\Capability\CommandProvider as CommandProviderCapability;
use VendorPatches202607\Composer\Plugin\Capable;
use VendorPatches202607\Composer\Plugin\PluginInterface;
use VendorPatches202607\Composer\Util\ProcessExecutor;
use VendorPatches202607\cweagans\Composer\Capability\CommandProvider;
use VendorPatches202607\cweagans\Composer\Capability\Downloader\CoreDownloaderProvider;
use VendorPatches202607\cweagans\Composer\Capability\Downloader\DownloaderProvider;
use VendorPatches202607\cweagans\Composer\Capability\Patcher\CorePatcherProvider;
use VendorPatches202607\cweagans\Composer\Capability\Patcher\PatcherProvider;
use VendorPatches202607\cweagans\Composer\Capability\Resolver\CoreResolverProvider;
use VendorPatches202607\cweagans\Composer\Capability\Resolver\ResolverProvider;
use VendorPatches202607\cweagans\Composer\ConfigurablePlugin;
use VendorPatches202607\cweagans\Composer\Downloader;
use VendorPatches202607\cweagans\Composer\Event\PatchEvent;
use VendorPatches202607\cweagans\Composer\Event\PatchEvents;
use VendorPatches202607\cweagans\Composer\Locker;
use VendorPatches202607\cweagans\Composer\Patch;
use VendorPatches202607\cweagans\Composer\PatchCollection;
use VendorPatches202607\cweagans\Composer\Patcher;
use VendorPatches202607\cweagans\Composer\Resolver;
use VendorPatches202607\cweagans\Composer\Util;
...
class Patches implements PluginInterface, EventSubscriberInterface, Capable
{
    ...
    {
        $composer_file = \VendorPatches202607\Composer\Factory::getComposerFile();
