 ...
 */
namespace VendorPatches202602\cweagans\Composer\Plugin;

use VendorPatches202602\Composer\Composer;
use VendorPatches202602\Composer\DependencyResolver\Operation\InstallOperation;
use VendorPatches202602\Composer\DependencyResolver\Operation\OperationInterface;
use VendorPatches202602\Composer\DependencyResolver\Operation\UpdateOperation;
use VendorPatches202602\Composer\EventDispatcher\EventDispatcher;
use VendorPatches202602\Composer\EventDispatcher\EventSubscriberInterface;
use VendorPatches202602\Composer\Installer\PackageEvent;
use VendorPatches202602\Composer\Installer\PackageEvents;
use VendorPatches202602\Composer\IO\IOInterface;
use VendorPatches202602\Composer\Json\JsonFile;
use VendorPatches202602\Composer\Package\PackageInterface;
use VendorPatches202602\Composer\Plugin\Capability\CommandProvider as CommandProviderCapability;
use VendorPatches202602\Composer\Plugin\Capable;
use VendorPatches202602\Composer\Plugin\PluginInterface;
use VendorPatches202602\Composer\Util\ProcessExecutor;
use VendorPatches202602\cweagans\Composer\Capability\CommandProvider;
use VendorPatches202602\cweagans\Composer\Capability\Downloader\CoreDownloaderProvider;
use VendorPatches202602\cweagans\Composer\Capability\Downloader\DownloaderProvider;
use VendorPatches202602\cweagans\Composer\Capability\Patcher\CorePatcherProvider;
use VendorPatches202602\cweagans\Composer\Capability\Patcher\PatcherProvider;
use VendorPatches202602\cweagans\Composer\Capability\Resolver\CoreResolverProvider;
use VendorPatches202602\cweagans\Composer\Capability\Resolver\ResolverProvider;
use VendorPatches202602\cweagans\Composer\ConfigurablePlugin;
use VendorPatches202602\cweagans\Composer\Downloader;
use VendorPatches202602\cweagans\Composer\Event\PatchEvent;
use VendorPatches202602\cweagans\Composer\Event\PatchEvents;
use VendorPatches202602\cweagans\Composer\Locker;
use VendorPatches202602\cweagans\Composer\Patch;
use VendorPatches202602\cweagans\Composer\PatchCollection;
use VendorPatches202602\cweagans\Composer\Patcher;
use VendorPatches202602\cweagans\Composer\Resolver;
use VendorPatches202602\cweagans\Composer\Util;
...
class Patches implements PluginInterface, EventSubscriberInterface, Capable
{
    ...
    {
        $composer_file = \VendorPatches202602\Composer\Factory::getComposerFile();
