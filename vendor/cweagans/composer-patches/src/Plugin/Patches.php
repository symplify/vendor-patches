 ...
 */
namespace VendorPatches202609\cweagans\Composer\Plugin;

use VendorPatches202609\Composer\Composer;
use VendorPatches202609\Composer\DependencyResolver\Operation\InstallOperation;
use VendorPatches202609\Composer\DependencyResolver\Operation\OperationInterface;
use VendorPatches202609\Composer\DependencyResolver\Operation\UpdateOperation;
use VendorPatches202609\Composer\EventDispatcher\EventDispatcher;
use VendorPatches202609\Composer\EventDispatcher\EventSubscriberInterface;
use VendorPatches202609\Composer\Installer\PackageEvent;
use VendorPatches202609\Composer\Installer\PackageEvents;
use VendorPatches202609\Composer\IO\IOInterface;
use VendorPatches202609\Composer\Json\JsonFile;
use VendorPatches202609\Composer\Package\PackageInterface;
use VendorPatches202609\Composer\Plugin\Capability\CommandProvider as CommandProviderCapability;
use VendorPatches202609\Composer\Plugin\Capable;
use VendorPatches202609\Composer\Plugin\PluginInterface;
use VendorPatches202609\Composer\Util\ProcessExecutor;
use VendorPatches202609\cweagans\Composer\Capability\CommandProvider;
use VendorPatches202609\cweagans\Composer\Capability\Downloader\CoreDownloaderProvider;
use VendorPatches202609\cweagans\Composer\Capability\Downloader\DownloaderProvider;
use VendorPatches202609\cweagans\Composer\Capability\Patcher\CorePatcherProvider;
use VendorPatches202609\cweagans\Composer\Capability\Patcher\PatcherProvider;
use VendorPatches202609\cweagans\Composer\Capability\Resolver\CoreResolverProvider;
use VendorPatches202609\cweagans\Composer\Capability\Resolver\ResolverProvider;
use VendorPatches202609\cweagans\Composer\ConfigurablePlugin;
use VendorPatches202609\cweagans\Composer\Downloader;
use VendorPatches202609\cweagans\Composer\Event\PatchEvent;
use VendorPatches202609\cweagans\Composer\Event\PatchEvents;
use VendorPatches202609\cweagans\Composer\Locker;
use VendorPatches202609\cweagans\Composer\Patch;
use VendorPatches202609\cweagans\Composer\PatchCollection;
use VendorPatches202609\cweagans\Composer\Patcher;
use VendorPatches202609\cweagans\Composer\Resolver;
use VendorPatches202609\cweagans\Composer\Util;
...
class Patches implements PluginInterface, EventSubscriberInterface, Capable
{
    ...
    {
        $composer_file = \VendorPatches202609\Composer\Factory::getComposerFile();
