 ...
 */
namespace VendorPatches202601\cweagans\Composer\Plugin;

use VendorPatches202601\Composer\Composer;
use VendorPatches202601\Composer\DependencyResolver\Operation\InstallOperation;
use VendorPatches202601\Composer\DependencyResolver\Operation\OperationInterface;
use VendorPatches202601\Composer\DependencyResolver\Operation\UpdateOperation;
use VendorPatches202601\Composer\EventDispatcher\EventDispatcher;
use VendorPatches202601\Composer\EventDispatcher\EventSubscriberInterface;
use VendorPatches202601\Composer\Installer\PackageEvent;
use VendorPatches202601\Composer\Installer\PackageEvents;
use VendorPatches202601\Composer\IO\IOInterface;
use VendorPatches202601\Composer\Json\JsonFile;
use VendorPatches202601\Composer\Package\PackageInterface;
use VendorPatches202601\Composer\Plugin\Capability\CommandProvider as CommandProviderCapability;
use VendorPatches202601\Composer\Plugin\Capable;
use VendorPatches202601\Composer\Plugin\PluginInterface;
use VendorPatches202601\Composer\Util\ProcessExecutor;
use VendorPatches202601\cweagans\Composer\Capability\CommandProvider;
use VendorPatches202601\cweagans\Composer\Capability\Downloader\CoreDownloaderProvider;
use VendorPatches202601\cweagans\Composer\Capability\Downloader\DownloaderProvider;
use VendorPatches202601\cweagans\Composer\Capability\Patcher\CorePatcherProvider;
use VendorPatches202601\cweagans\Composer\Capability\Patcher\PatcherProvider;
use VendorPatches202601\cweagans\Composer\Capability\Resolver\CoreResolverProvider;
use VendorPatches202601\cweagans\Composer\Capability\Resolver\ResolverProvider;
use VendorPatches202601\cweagans\Composer\ConfigurablePlugin;
use VendorPatches202601\cweagans\Composer\Downloader;
use VendorPatches202601\cweagans\Composer\Event\PatchEvent;
use VendorPatches202601\cweagans\Composer\Event\PatchEvents;
use VendorPatches202601\cweagans\Composer\Locker;
use VendorPatches202601\cweagans\Composer\Patch;
use VendorPatches202601\cweagans\Composer\PatchCollection;
use VendorPatches202601\cweagans\Composer\Patcher;
use VendorPatches202601\cweagans\Composer\Resolver;
use VendorPatches202601\cweagans\Composer\Util;
...
class Patches implements PluginInterface, EventSubscriberInterface, Capable
{
    ...
    {
        $composer_file = \VendorPatches202601\Composer\Factory::getComposerFile();
