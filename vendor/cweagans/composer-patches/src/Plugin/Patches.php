 ...
 */
namespace VendorPatches202511\cweagans\Composer\Plugin;

use VendorPatches202511\Composer\Composer;
use VendorPatches202511\Composer\DependencyResolver\Operation\InstallOperation;
use VendorPatches202511\Composer\DependencyResolver\Operation\OperationInterface;
use VendorPatches202511\Composer\DependencyResolver\Operation\UpdateOperation;
use VendorPatches202511\Composer\EventDispatcher\EventDispatcher;
use VendorPatches202511\Composer\EventDispatcher\EventSubscriberInterface;
use VendorPatches202511\Composer\Installer\PackageEvent;
use VendorPatches202511\Composer\Installer\PackageEvents;
use VendorPatches202511\Composer\IO\IOInterface;
use VendorPatches202511\Composer\Json\JsonFile;
use VendorPatches202511\Composer\Package\PackageInterface;
use VendorPatches202511\Composer\Plugin\Capability\CommandProvider as CommandProviderCapability;
use VendorPatches202511\Composer\Plugin\Capable;
use VendorPatches202511\Composer\Plugin\PluginInterface;
use VendorPatches202511\Composer\Util\ProcessExecutor;
use VendorPatches202511\cweagans\Composer\Capability\CommandProvider;
use VendorPatches202511\cweagans\Composer\Capability\Downloader\CoreDownloaderProvider;
use VendorPatches202511\cweagans\Composer\Capability\Downloader\DownloaderProvider;
use VendorPatches202511\cweagans\Composer\Capability\Patcher\CorePatcherProvider;
use VendorPatches202511\cweagans\Composer\Capability\Patcher\PatcherProvider;
use VendorPatches202511\cweagans\Composer\Capability\Resolver\CoreResolverProvider;
use VendorPatches202511\cweagans\Composer\Capability\Resolver\ResolverProvider;
use VendorPatches202511\cweagans\Composer\ConfigurablePlugin;
use VendorPatches202511\cweagans\Composer\Downloader;
use VendorPatches202511\cweagans\Composer\Event\PatchEvent;
use VendorPatches202511\cweagans\Composer\Event\PatchEvents;
use VendorPatches202511\cweagans\Composer\Locker;
use VendorPatches202511\cweagans\Composer\Patch;
use VendorPatches202511\cweagans\Composer\PatchCollection;
use VendorPatches202511\cweagans\Composer\Patcher;
use VendorPatches202511\cweagans\Composer\Resolver;
use VendorPatches202511\cweagans\Composer\Util;
...
class Patches implements PluginInterface, EventSubscriberInterface, Capable
{
    ...
    {
        $composer_file = \VendorPatches202511\Composer\Factory::getComposerFile();
