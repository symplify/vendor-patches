 ...
 */
namespace VendorPatches202207\cweagans\Composer\Tests;

use VendorPatches202207\cweagans\Composer\PatchEvent;
use VendorPatches202207\cweagans\Composer\PatchEvents;
use VendorPatches202207\Composer\Package\PackageInterface;
class PatchEventTest extends \VendorPatches202207\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $prophecy = $this->prophesize('VendorPatches202207\\Composer\\Package\\PackageInterface');
