 ...
 */
namespace VendorPatches202301\cweagans\Composer\Tests;

use VendorPatches202301\cweagans\Composer\PatchEvent;
use VendorPatches202301\cweagans\Composer\PatchEvents;
use VendorPatches202301\Composer\Package\PackageInterface;
class PatchEventTest extends \VendorPatches202301\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $prophecy = $this->prophesize('VendorPatches202301\\Composer\\Package\\PackageInterface');
