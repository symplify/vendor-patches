 ...
 */
namespace VendorPatches202206\cweagans\Composer\Tests;

use VendorPatches202206\cweagans\Composer\PatchEvent;
use VendorPatches202206\cweagans\Composer\PatchEvents;
use VendorPatches202206\Composer\Package\PackageInterface;
class PatchEventTest extends \VendorPatches202206\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $prophecy = $this->prophesize('VendorPatches202206\\Composer\\Package\\PackageInterface');
