 ...
 */
namespace VendorPatches202302\cweagans\Composer\Tests;

use VendorPatches202302\cweagans\Composer\PatchEvent;
use VendorPatches202302\cweagans\Composer\PatchEvents;
use VendorPatches202302\Composer\Package\PackageInterface;
class PatchEventTest extends \VendorPatches202302\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $prophecy = $this->prophesize('VendorPatches202302\\Composer\\Package\\PackageInterface');
