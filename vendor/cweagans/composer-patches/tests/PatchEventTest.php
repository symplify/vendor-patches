 ...
 */
namespace VendorPatches202212\cweagans\Composer\Tests;

use VendorPatches202212\cweagans\Composer\PatchEvent;
use VendorPatches202212\cweagans\Composer\PatchEvents;
use VendorPatches202212\Composer\Package\PackageInterface;
class PatchEventTest extends \VendorPatches202212\PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $prophecy = $this->prophesize('VendorPatches202212\\Composer\\Package\\PackageInterface');
