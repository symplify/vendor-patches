...
namespace VendorPatches202208\Symplify\AutowireArrayParameter\DependencyInjection;
...
use VendorPatches202208\Symplify\AutowireArrayParameter\Exception\DependencyInjection\DefinitionForTypeNotFoundException;
use Throwable;
/**
 * @api
