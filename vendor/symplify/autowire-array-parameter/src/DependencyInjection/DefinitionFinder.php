...
namespace VendorPatches202302\Symplify\AutowireArrayParameter\DependencyInjection;
...
use VendorPatches202302\Symplify\AutowireArrayParameter\Exception\DependencyInjection\DefinitionForTypeNotFoundException;
use Throwable;
/**
 * @api
