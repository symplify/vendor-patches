...
namespace VendorPatches202301\Symplify\AutowireArrayParameter\DependencyInjection;
...
use VendorPatches202301\Symplify\AutowireArrayParameter\Exception\DependencyInjection\DefinitionForTypeNotFoundException;
use Throwable;
/**
 * @api
