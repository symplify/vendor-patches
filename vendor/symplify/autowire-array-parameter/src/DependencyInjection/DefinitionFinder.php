...
namespace VendorPatches202207\Symplify\AutowireArrayParameter\DependencyInjection;
...
use VendorPatches202207\Symplify\AutowireArrayParameter\Exception\DependencyInjection\DefinitionForTypeNotFoundException;
use Throwable;
/**
 * @api
