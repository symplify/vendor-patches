...
use VendorPatches202609\Entropy\Utils\Regex;
...
final class PatchDiffer
{
    /**
     * @readonly
     * @var \Symplify\VendorPatches\Differ\UnifiedDiffer
     */
    ...
    public function __construct(\Symplify\VendorPatches\Differ\UnifiedDiffer $unifiedDiffer)
    {
